...
namespace ProductionLinesWEG.Hub
{
    ...
    public class MasterHub : Microsoft.AspNet.SignalR.Hub
    {
        ...
        public void RegisterMessageDashboard(string message, int nivel, string silentMode)
        {
            Program pgm = CheckPgmInSimulation();
        ...
        public void CreateProcess(string name, string description, int runTime, double variationRuntime, double errorProbability, string nameFather, int position)
        {
            ...
            if (pgm != null)
            {
                ...
                {
                    RegisterMessageDashboard("Limite de caracteres antingido", 2, true);
                }
            }
        }
        ...
        public void turnOnEsteira(string id)
        {
            ...
            if (pgm != null)
            {
                ...
                if (e != null)
                {
                    e.TurnOn(pgm, Context.ConnectionId, true);
                }
                else
                {
        ...
        private void turnOnAllFrontR(Program pgm, EsteiraAbstrata e)
        {
            if (e is SetableOutput se)
            {
                ...
                {
                    e.TurnOn(pgm, Context.ConnectionId, false);
        ...
        private void turnOffAllFrontR(Program pgm, EsteiraAbstrata e)
        {
            ...
            {
                e.TurnOff(pgm);
                RegisterMessageDashboard("Esteira '" + e.Name + "' desligada", 1, "");
            }
